...
class sms_sender {
    ...
    */
    public function send($mobile,$content) {
		$mobile_host_type=app_conf('mobile_host_type');
	...
	*/
    private function mysend_smsbao($mobile,$content){
	   ...
	   $user_id = urlencode(app_conf('mobile_username')); // 这里填写用户名
 	   $pass = urlencode(app_conf('mobile_pwd')); // 这里填登陆密码
    ...
    private function mysend_yunpian($mobile,$content) {
        ...
        require_once(SYSTEM_PATH.'smsapi/yunpian/Send.php');
