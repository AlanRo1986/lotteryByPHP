...
var app = {
     ...
     */
    ajax: function (url, data, fnScuss, fnError,isAsync) {
        ...
        var http = function (method,header,noLoading) {
            if(!noLoading){
        ...
        return {
            ...
            post: function (isJson,noLoading) {
                //缓存判断
                if (_isCanCache == true){
                    _cache = app.cache.get(_cacheKey)
                    if (_cache != null && typeof fnScuss == "function"){
